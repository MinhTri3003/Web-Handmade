              ...
              <div class="product-shop col-sm-7 col-xs-12 bounceInUp animated">
                ...
                <div class="price-block">
                  <div class="price-box">
                    ...
                    <p class="special-price"> <span class="price-label"></span> <span id="product-price-48" class="price"> {{number_format($value->product_price).'VNĐ'}} </span> </p>
                  </div>
                </div>
                <div class="add-to-box">
                  ...
                  <div class="email-addto-box">
                    ...
                    <ul class="add-to-links">
                      <li> <a class="link-wishlist" href="wishlist.html"><span>Yêu thích</span></a></li>
                    ...
                    <div class="item-box-hover">
                      <div class="box-inner">                                        
                                        ...
                                        <div class="add_cart">
                                          <form action="{{URL::to('/save-cart')}}" method="post">
                    {{ csrf_field() }}
                                          <button class="button btn-cart" type="button" title="Thêm giỏ hàng"><span>Thêm giỏ hàng</span></button>
                                        </form>
                                        </div>
                                        <div class="product-detail-bnt"><a href="" class="button detail-bnt" title="Xem sản phẩm"><span>Xem sản phẩm</span></a></div> <span class="add-to-links"><a href="" class="link-wishlist" title="Yêu thích"><span>Yêu thích</span></a> 
 <a href="" class="link-compare add_to_compare" title="So sánh" ><span>So sánh</span></a></span> </div>
                                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="item-content">
                      ...
                      <div class="item-price">
                        <div class="price-box">
                          ...
                          <p class="special-price"> <span class="price-label">Giá bán</span> <span id="product-price-2" class="price">{{number_format($lienquan->product_price).'VNĐ'}}</span> </p>
                        </div>
                      </div>
                    </div>
                  </div>
