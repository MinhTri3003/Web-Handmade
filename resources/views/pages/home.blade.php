      ...
      <div class="row">
        <div class="col-lg-3 col-sm-3 col-xs-6">
          <div class="col add-banner1">
            <a href=""><div class="top-b-text"><strong>Chậu hoa</strong></div></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-6">
          <div class="col add-banner2">
            <a href=""><div class="top-b-text"><strong>Thiệp mời</strong></div></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-6">
          <div class="col add-banner3">
            <a href=""><div class="top-b-text"><strong>Hộp quà</strong></div></a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-3 col-xs-6">
          <div class="col add-banner4">
            <a href=""><div class="top-b-text"><strong>Trang trí</strong></div></a>
          </div>
        </div>
      </div>
    </div>
                                      ...
                                      <div class="box-inner">
                                        <div class="actions">
                                          <div class="add_cart">
                                            ...
                                            <button class="button btn-cart" type="submit"title="Thêm vào giỏ hàng"><span>Thêm vào giỏ hàng</span></button>
                                         
                                          </div>
                                          <div class="product-detail-bnt"><a href="{{URL::to('/chi-tiet-san-pham/'.$product->product_id)}}" class="button detail-bnt" title="Xem sản phẩm"><span>Xem sản phẩm</span></a></div>
