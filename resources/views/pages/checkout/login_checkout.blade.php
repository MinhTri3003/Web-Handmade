    ...
    <div class="main container">
      <div class="account-login">
        ...
        <fieldset class="col2-set">
          <legend>Đăng ký hoặc đăng nhập tài khoản</legend>
            ...
            <div class="content">
              ...
              <ul class="form-list">
                <li>
                  ...
                  <br>
                  <input type="text" title="Name" class="input-text" id="name" value="" placeholder="Nhập họ và tên" name="customer_name">
                </li>
                <li>
                  <label for="email">Email <span class="required">*</span></label>
                  <br>
                  <input type="text" title="Email Address" class="input-text" id="email" value="" placeholder="Nhập email" name="customer_email">
                </li>
                <li>
                  <label for="pass">Mật khẩu <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass" class="input-text" placeholder="Nhập mật khẩu" name="customer_password">
                </li>
                <li>
                  <label for="pass">Số điện thoại <span class="required">*</span></label>
                  <br>
                  <input type="sdt" title="sdt" id="sdt" placeholder="Nhập số điện thoại" class="input-text" name="customer_phone">
                </li>
              </ul>
              <p class="required">* Bắt buộc</p>
              <div class="buttons-set">
                <button id="send2" name="dangky" type="submit" class="button login"><span>Đăng ký</span></button>
                </div>
              </form>
            </div>
          </div>
            ...
            <div class="content">
              ...
              <ul class="form-list">
                <li>
                  <label for="email">Email  <span class="required">*</span></label>
                  <br>
                  <input type="text" title="Email Address" class="input-text" id="email"   name="email_account">
                </li>
                <li>
                  <label for="pass">Mật khẩu <span class="required">*</span></label>
                  <br>
                  <input type="password" title="Password" id="pass" class="input-text" name="password_account">
                </li>
              </ul>
              <p class="required">* Bắt buộc</p>
              <div class="buttons-set">
                <button id="send2" name="send" type="submit" class="button login"><span>Đăng nhập</span></button>
                <a class="forgot-word" href="#">Bạn quên mật khẩu?</a> </div>
              </form>
            </div>
          </div>
        </fieldset>
