...
<div id="page"> 
                  ...
                  <div class="top-cart-content" style="display: none;">
                    <div class="block-subtitle">
                      ...
                      <div class="pull-right">
                        <a href="{{URL::to('/show-cart')}}"><button title="View Cart" class="view-cart" type="button"><span>Xem giỏ hàng</span></button></a>
                      </div>
                      <!--pull-right--> 
                    </div>
                    <?php
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
        <h4 class="mb-3">Cảm ơn bạn đã đặt hàng, chúng tôi sẽ liên hệ với bạn sớm nhất</h4>
