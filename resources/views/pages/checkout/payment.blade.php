            ...
            <div class="toplinks"> 
              ...
              <div class="links">
               ...
               <?php
                 ...
                 ?>
                <div class="login"><a href="{{URL::to('/payment')}}"><span class="hidden-xs">Thanh toán</span></a></div>
                <?php
               }else {
                 ?>
    ...
    <div class="col-md-8 order-md-1">
        ...
        <div class="d-block my-3">
          ...
          <div class="custom-control custom-radio">
            ...
            <label class="custom-control-label" for="debit">Thanh toán tiền mặt</label>
          </div>
          
          <div class="custom-control custom-radio">
            <input id="paypal" name="payment_option" value="3" type="radio" class="custom-control-input" required>
            <label class="custom-control-label" for="paypal">Thanh toán ví điện tử</label>
          </div>
          <div class="custom-control custom-radio">
            <input id="paypal" name="payment_option" value="4" type="radio" class="custom-control-input" required>
        ...
        {{-- <div class="row">
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">
              Vui lòng nhập tên chủ thẻ đúng!
            </div>
          </div>
          <div class="col-md-6 mb-3">
            ...
            <div class="invalid-feedback">
              Vui lòng nhập số thẻ đúng!
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 mb-3">
            <label for="cc-expiration">Chi nhánh</label>
            <input type="text" class="form-control" id="cc-expiration" placeholder="" required>
            <div class="invalid-feedback">
              Vui lòng nhập đúng chi nhánh!
            </div>
          </div>
          
        </div> --}}
        <hr class="mb-4">
        <button class="btn-primary btn-lg btn-block" type="submit" name="send_order">Đặt hàng</button>
        <br>
      </form>
    </div>
  </div>
