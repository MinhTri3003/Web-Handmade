...
<div id="page"> 
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      <h4 class="mb-3">Điền thông tin gửi hàng</h4>
      <form  method="POST" action="{{URL::to('/save-checkout-customer')}}">
        {{ csrf_field() }}
        <div class="row">
          <div class="col-md-6 mb-6">
            <label for="firstName">Họ và tên</label>
            <input type="text" class="form-control" id="firstName" placeholder="Nhập họ và tên"  name="shipping_name" required>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="phone"name="shipping_phone" placeholder="Số điện thoại" required>
          <div class="invalid-feedback">
        ...
        <button class="btn-primary btn-lg btn-block" type="submit" name="send_order">Thanh toán</button>
        <br>
      </form>
    </div>
  </div>
