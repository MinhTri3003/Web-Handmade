...
<div class="right__content">
    ...
    <div class="right__cards">
        <a class="right__card" href="view_product.html">
            ...
            <div class="right__cardDesc">Xem Chi Tiết <img src="{{asset('public/frontend/admin/assets/arrow-right.svg')}}" alt=""></div>
        </a>
    ...
    <div class="right__table">
        ...
        <a href="" class="right__tableMore"><p>Xem tất cả các đơn đặt hàng</p> <img src="{{asset('public/frontend/admin/assets/arrow-right-black.svg')}}" alt=""></a>
    </div>
</div>
</div>
</div>
